...
function [points] = rotationX (theta)
l1 = [ 1, 0, 0, 0]
l2 = [ 0, cos(theta) , -sin(theta), 0 ]
l3 = [ 0, sin(theta) , cos(theta), 0 ]
l4= [ 0, 0, 0, 1]
points = [l1; l2; l3; l4]
endfunction
...
function [points] = rotationY (theta)
l1 = [ cos(theta), 0, sin(theta), 0]
l2 = [ 0, 1 , 0, 0 ]
l3 = [ -sin(theta), 0 , cos(theta), 0 ]
l4= [ 0, 0, 0, 1]
points = [l1; l2; l3; l4]
endfunction
...
function [points] = rotationZ (theta)
l1 = [ cos(theta), -sin(theta), 0, 0]
l2 = [ sin(theta), cos(theta) , 0, 0 ]
l3 = [ 0, 0 , 1, 0 ]
l4= [ 0, 0, 0, 1]
points = [l1; l2; l3; l4]
endfunction
...
function [points] = translation (x, y , z)
l1 = [ 1, 0, 0, x]
l2 = [ 0, 1, 0, y ]
l3 = [ 0, 0 , 1, z ]
l4= [ 0, 0, 0, 1]
